...
# Set computer name
COMPUTERNAME="Key's MacBook Pro"
HOSTNAME='mbp'
LOCALHOSTNAME='mbp'
...
defaults write -g AppleTemperatureUnit -string "Celcius"
...
cp -r confs/Preferences.sublime-settings ~/Library/Application\ Support/Sublime\ Text*/Packages/User/Preferences.sublime-settings 2> /dev/null
